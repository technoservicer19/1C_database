...
Атрибут доступен для объекта типа V7Mail"
    ...
    {"Item","AST","ДатаОтправки","DatеSend",
"ДатаОтправки",
"DatеSend",
"@Синтаксис
ДатаОтправки
...
Метод доступен для объекта типа V7Mail"
    ...
    {"Item","AST","НовоеСообщение","NewMessage",
"НовоеСообщение(<?>);",
"NewMessage(<?>);",
"@Синтаксис
НовоеСообщение()
...
Метод доступен для объекта типа V7Mail"
    ...
    {"Item","AST","ДобавитьАдрес","AddAddress",
"ДобавитьАдрес(<?>);",
"AddAddress(<?>);",
"@Синтаксис
ДобавитьАдрес(<Адрес>)
...
Метод доступен для объекта типа V7Mail"
    ...
    {"Item","AST","ВыбратьСообщения","SelectMеssages",
"ВыбратьСообщения();",
"SelectMеssages();",
"@Синтаксис
ВыбратьСообщения()
...
Метод доступен для объекта типа V7Mail"
    ...
    {"Item","AST","ПолучитьСообщение","ReceiveMessage",
"ПолучитьСообщение();",
"ReceiveMessage();",
"@Синтаксис
ПолучитьСообщение()
...
Метод доступен для объекта типа V7Mail"
    ...
    {"Item","AST","ПрочитатьСообщение","ReadMessage",
"ПрочитатьСообщение(<?>);",
"ReadMessage(<?>);",
"@Синтаксис
...
Метод доступен для объекта типа V7Mail"
    ...
    {"Item","AST","АдресОтправителя","SenderAddress",
"АдресОтправителя();",
"SenderAddress();",
"@Синтаксис
АдресОтправителя()
...
Метод доступен для объекта типа V7Mail"
    ...
    {"Item","AST","УдалитьСообщение","DeleteMessage",
"УдалитьСообщение();",
"DeleteMessage();",
"@Синтаксис
УдалитьСообщение()
...
Метод доступен для объекта типа V7Mail"
 ...
 {"Folder","AST","Атрибуты","",
    {"Item","AST","КоличествоПопытокАвторизации","AuthAttemptsNum",
...
Соединение.КоличествоПопытокАвторизации = 0;"
    ...
    {"Item","AST","СтрокаСостоянияОтвета","ResponseStatusLine",
...
Соединение.Пользователь(''Guest'', ''Password'');"
    ...
    {"Item","AST","ПолучитьКакФайл","ReceiveAsFile",
"ПолучитьКакФайл(<?>,);",
"ReceiveAsFile(<?>,);",
"@Синтаксис
...
КонецПопытки ;"
    ...
    {"Item","AST","ПолучитьКакСтроку","ReceiveAsFile",
"ПолучитьКакСтроку(<?>,);",
"ReceiveAsString(<?>,);",
"@Синтаксис
...
КонецПопытки ;"
    ...
    {"Item","AST","ПолучитьКакОбъект","ReceiveAsObject",
"ПолучитьКакОбъект(<?>,);",
"ReceiveAsObject(<?>,);",
"@Синтаксис
...
''http://www.ResourceServer.ru/res/price.xml'', XMLДокумент);"
    ...
    {"Item","AST","ОтправитьДляОбработки","SendAndProcess",
...
XMLДокументОтпр, 3, XMLДокументПолуч, 3);"
    ...
    {"Item","AST","УдалитьЗаголовкиЗапроса","removeRequestHeaders",
...
HTTPСоединение.УдалитьЗаголовкиЗапроса();"
    ...
    {"Item","AST","УстановитьЗаголовокЗапроса","setRequestHeader",
...
''MyAction'',''Upload'');"
    ...
    {"Item","AST","ПолучитьЗаголовокОтвета","getResponseHeader",
...
Заголовок = HTTPСоединение.ПолучитьЗаголовокОтвета(1);"
    ...
    {"Item","AST","ПолучитьСодержаниеЗаголовкаОтвета","getResponseContents",
...
HTTPСоединение.ПолучитьСодержаниеЗаголовокаОтвета(''SrvAction'') ;"
    ...
    {"Item","AST","КоличествоЗаголовковОтвета","getResponseHeadersNumber",
"КоличествоЗаголовковОтвета();",
"getResponseHeadersNumber();",
"@Синтаксис
 КоличествоЗаголовковОтвета()
@Назначение
Возвращает содержание заголовка.
...
Атрибут доступен для объекта типа V7SysInfo"
    ...
    {"Item","AST","ОперативнаяПамять","Memory",
"ОперативнаяПамять",
"Memory",
"@Синтаксис
ОперативнаяПамять
...
Атрибут доступен для объекта типа V7SysInfo"
    ...
    {"Item","AST","РелизПрограммы","ProgrammRelease",
"РелизПрограммы",
"ProgrammRelease",
"@Синтаксис
РелизПрограммы
...
Атрибут доступен для объекта типа V7SysInfo"
    ...
    {"Item","AST","ИмяФайлаПрограммы","ProgrammFileName",
"ИмяФайлаПрограммы",
"ProgrammFileName",
"@Синтаксис
ИмяФайлаПрограммы
...
Атрибут доступен для объекта типа V7SysInfo"
 ...
 {"Folder","AST","Методы","",
    {"Item","AST","ПроверитьИмяФайла","CheckFileName",
"ПроверитьИмяФайла(<?>);",
"CheckFileName(<?>);",
"@Синтаксис
...
Метод доступен для объекта типа V7SysInfo"
    ...
    {"Item","AST","СоздатьGUID","CreateGUID",
"СоздатьGUID();",
"CreateGUID();",
"@Синтаксис
СоздатьGUID()
...
ГлобальноУникальныйИдентификатор = Инфо.СоздатьGUID();"
 ...
 {"Folder","AST","Атрибуты","",
    {"Item","AST","ВерсияАнализатора","ParserVersion",
"ВерсияАнализатора",
"ParserVersion",
"@Синтаксис
ВерсияАнализатора
...
Версия = Анализатор. ВерсияАнализатора ;"
    ...
    {"Item","AST","ВерсияБазовогоАнализатора","BaseParserVersion",
...
Версия = Анализатор. ВерсияАнализатора ;"
 ...
 {"Folder","AST","Методы","",
    {"Item","AST","СоздатьДокумент","CreateDocument",
"СоздатьДокумент()",
"CreateDocument()",
"@Синтаксис:
СоздатьДокумент()
...
Документ = Анализатор.СоздатьДокумент() ;"
    ...
    {"Item","AST","СоздатьКоллекциюСхем","CreateSchemasCollection",
...
КонецЕсли ;"
    ...
    {"Item","AST","ТипСтрока","nodeTypeString",
"ТипСтрока",
"nodeTypeString",
"@Синтаксис
ТипСтрока
...
Сообщить(''Тип узла - '' + Узел.ТипСтрока) ;"
    ...
    {"Item","AST","ПолноеНаименование","nodeName",
"ПолноеНаименование",
"nodeName",
"@Синтаксис
ПолноеНаименование
...
Сообщить(''Полное наименование узла - '' + Узел.ПолноеНаименование) ;"
    ...
    {"Item","AST","Наименование","baseName",
"Наименование",
"baseName",
"@Синтаксис
Наименование
...
ЭлПодразделение = ЭлСотрудник.Родитель;"
    ...
    {"Item","AST","ДокументВладелец","ownerDocument",
"ДокументВладелец",
"ownerDocument",
"@Синтаксис
ДокументВладелец
...
Сообщить(''Представление узла - '' + Узел.ПредставлениеXML);"
 ...
 {"Folder","AST","Методы","",
    {"Item","AST","КоличествоПодчиненных","NumberChilds",
...
см. пример для метода ПолучитьПодчиненныйПоНомеру"
    ...
    {"Item","AST","ПолучитьПодчиненныйПоНомеру","GetChildByNum",
...
КонецЦикла ;"
    ...
    {"Item","AST","ДобавитьПодчиненный","appendChild",
"ДобавитьПодчиненный(<?>,)",
"appendChild(<?>,)",
"@Синтаксис:
...
Документ.ДобавитьПодчиненный(ИнструкцияОбработки, Документ.ЭлементДокумента) ;"
    ...
    {"Item","AST","УдалитьПодчиненный","removeChild",
"УдалитьПодчиненный(<?>)",
"removeChild(<?>)",
"@Синтаксис
...
Документ.УзелДокумента.УдалитьПодчиненный(ПервыйПодчиненный);"
    ...
    {"Item","AST","ВыбратьУзлы","selectNodes",
"ВыбратьУзлы(<?>)",
"selectNodes(<?>)",
"@Синтаксис:
...
Выборка = Документ.УзелДокумента.ВыбратьУзлы(''Товар'') ;"
    ...
    {"Item","AST","ВыбратьУзел","selectSingleNode",
"ВыбратьУзел(<?>)",
"selectSingleNode(<?>)",
"@Синтаксис:
...
Каталог = Документ.УзелДокумента.ВыбратьУзел(''//ИнформацияОТоварах'') ;"
    ...
    {"Item","AST","СоздатьПодчиненныйЭлемент","createChildElement",
...
НовыйТовар = Документ.УзелДокумента.СоздатьПодчиненныйЭлемент(''Товар'') ;"
    ...
    {"Item","AST","ПреобразоватьВ_ИД","ConvertToID",
"ПреобразоватьВ_ИД(<?>)",
"ConvertToID(<?>)",
"@Синтаксис
...
ЭлТовар.УстановитьАтрибут( ''ИДТовара'',  ЭлТовар. ПреобразоватьВ_ИД(СтрИД)) ;"
 ...
 {"Folder","AST","Документ","",
 {"Folder","AST","Атрибуты","",
    {"Item","AST","ЭлементДокумента","documentElement",
"ЭлементДокумента",
"documentElement",
"@Синтаксис
ЭлементДокумента
...
Документ.Кодировка = ''UTF-16'';"
    ...
    {"Item","AST","ПространстваИмен","namespaces",
"ПространстваИмен",
"namespaces",
"@Синтаксис
ПространстваИмен
...
См. пример в описании метода Проверить."
    ...
    {"Item","AST","РазрешатьВнешниеСсылки","resolveExternals",
...
Документ.Записать(''C:\XMLDocuments\SrcDocument.xml'');"
    ...
    {"Item","AST","ЗагрузитьИзСтроки","loadXML",
"ЗагрузитьИзСтроки(<?>)",
"loadXML(<?>)",
"@Синтаксис:
...
Документ2.ЗагрузитьИзСтроки(Документ1.ПредставлениеXML);"
    ...
    {"Item","AST","СоздатьУзел","createNode",
"СоздатьУзел(<?>,<?>,<?>)",
"createNode(<?>,<?>,<?>)",
"@Синтаксис:
...
Сообщить(''Тег элемента - '' + Элемент.ИмяТега);"
 ...
 {"Folder","AST","Методы","",
    {"Item","AST","УстановитьАтрибут","setAttribute",
"УстановитьАтрибут(<?>,<?>)",
"setAttribute(<?>,<?>)",
"@Синтаксис:
...
Пример:"
    ...
    {"Item","AST","ПолучитьАтрибут","getAttribute",
"ПолучитьАтрибут (<?>)",
"getAttribute(<?>)",
"@Синтаксис:
...
ДатаПриемаНаРаботу = ЭлСотрудник.ПолучитьАтрибут(''ДатаПриема'');"
    ...
    {"Item","AST","КоличествоАтрибутов","AttributesNumber",
"КоличествоАтрибутов()",
"AttributesNumber()",
"@Синтаксис:
КоличествоАтрибутов()
...
КонецЦикла"
    ...
    {"Item","AST","ПолучитьУзелАтрибута","getAttributeNode",
...
см. также пример из описания метода КоличествоАтрибутов"
    ...
    {"Item","AST","УдалитьАтрибут","removeAttribute",
"УдалитьАтрибут(<?>)",
"removeAttribute(<?>)",
"@Синтаксис:
...
ЭлСотрудник.УдалитьАтрибут(ЭлСотрудник.ПолучитьУзелАтрибута(''ДатаПриема'')) ;"
    ...
    {"Item","AST","ДобавитьАтрибут","addAttribute",
"ДобавитьАтрибут(<?>)",
"addAttribute(<?>)",
"@Синтаксис:
...
Атр.Значение = ТекущаяДата() ;"
    ...
    {"Item","AST","УстановитьПространствоИмен","setNamespace",
...
Док.ЭлементДокумента.УстановитьПространствоИмен(''urn:schemas-microsoft-com:datatypes'',''dt'');"
 ...
 {"Folder","AST","Атрибуты","",
    {"Item","AST","КоличествоСхем","length",
"КоличествоСхем",
"length",
"@Синтаксис
КоличествоСхем
...
КоллекцияСхем.УдалитьСхему(''http://server/schemas/Sc1.xml'');"
    ...
    {"Item","AST","УникальныйИДРесурсаПространстваИмен","namespaceURI",
...
Сообщить(Документ.ПространстваИмен.УникальныйИДРесурсаПространстваИмен(0));"
 ...
 {"Folder","AST","Атрибуты","",
    {"Item","AST","КоличествоУзлов","length",
"КоличествоУзлов",
"length",
"@Синтаксис
КоличествоУзлов
